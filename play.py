...
class SaveButton(Button):
    ...
    def save():
        ...
        with open("saved game.json", "w") as file:
            saved_game = {"current_level_parameter": level.current_level,
                          "current_wave_parameter": level.current_wave_number, "bullet_level": player.sprite.bullet_lvl,
                          "bullet_type": player.sprite.bull_type, "score": player.sprite.score}
            print(saved_game)
